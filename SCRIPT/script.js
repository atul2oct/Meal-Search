            ...
            await fetchMealsFromApi(url,arr[index]).then(data=>{
                ...
                <div id="card" class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn-pink" onclick="showMealDetails(${data.meals[0].idMeal})">More Details</button>
                            <button id="main${data.meals[0].idMeal}" class="btn btn-outline-secondary active" onclick="addRemoveToFavList(${data.meals[0].idMeal})" style="border-radius:50%"><i class="fa-solid fa-heart"></i></button>
                        </div>
                    </div>
                </div>
                `;
